...
% direct drop-in replacement for how we were using it.  This is the
% replacement.
% uri_string:dissect_query/1 returns key-value pairs, and the value will
% often or always be true based on my testing.
unencode(X) ->
